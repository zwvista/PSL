...
extern void solve_puz_ColorMaze();
...
int main(int argc, char **argv)
{
    ...
    for(string str; str.empty();) {
        ...
        println("o2: Color Maze");
        println("o3: Connect Puzzle");
        println("o4: Consecutives");
        ...
        getline(cin, str);
        if (str.empty()) solve_puz_CastlePatrol2();
        ...
        else if (str == "o2") solve_puz_ColorMaze();
        else if (str == "o3") solve_puz_ConnectPuzzle();
        else if (str == "o4") solve_puz_Consecutives();
