...
extern void solve_puz_SlitherArrowLink();
...
int main(int argc, char **argv)
{
    ...
    for(string str; str.empty();) {
        ...
        println("l2: SlitherArrowLink");
        println("l3: SlitherCorner");
        println("l4: SlitherLink");
        println("n1: Snail");
        println("n2: Snake");
        ...
        getline(cin, str);
        if (str.empty()) solve_puz_SlitherArrowLink();
        ...
        else if (str == "l2") solve_puz_SlitherArrowLink();
        else if (str == "l3") solve_puz_SlitherCorner();
        else if (str == "l4") solve_puz_SlitherLink();
