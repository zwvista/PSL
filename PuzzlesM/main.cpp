...
int main(int argc, char **argv)
{
    ...
    cout << "a3: Masyu" << endl;
    cout << "a4: Matchstick Equation" << endl;
    cout << "a5: Matchstick Squares" << endl;
    cout << "a6: Matchstick Triangles" << endl;
    cout << "a7: Mathrax" << endl;
    cout << "a8: mazecat" << endl;
    ...
    else if(str == "a4") solve_puz_MatchstickEquation();
    else if(str == "a5") solve_puz_MatchstickSquares();
    else if(str == "a6") solve_puz_MatchstickTriangles();
    else if(str == "a7") solve_puz_Mathrax();
    else if(str == "a8") solve_puz_mazecat();
