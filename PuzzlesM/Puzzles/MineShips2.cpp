...
void solve_puz_MineShips2()
{
    using namespace puzzles::MineShips2;
    solve_puzzle<puz_game, puz_state, puz_solver_astar<puz_state>>(
        "Puzzles/MineShips.xml", "Puzzles/MineShips2.txt", solution_format::GOAL_STATE_ONLY);
}
