...
/*
    iOS Game: 100 Logic Games/Puzzle Set 13/Robot Fences
...
namespace puzzles::RobotFences2{
...
void solve_puz_RobotFences2()
{
    using namespace puzzles::RobotFences2;
    solve_puzzle<puz_game, puz_state, puz_solver_astar<puz_state>>
        ("Puzzles/RobotFences.xml", "Puzzles/RobotFences2.txt", solution_format::GOAL_STATE_ONLY);
}
