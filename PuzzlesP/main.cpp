...
int main(int argc, char **argv)
{
    ...
    println("ar4: Parks2");
    println("at1: Pata");
    println("at2: Patchmania");
    println("at3: pathfind");
    println("at4: Path on the Hills");
    println("at5: Path on the Mountains");
    println("at6: patternpuzzle");
    ...
    else if (str == "at2") solve_puz_Patchmania();
    else if (str == "at3") solve_puz_pathfind();
    else if (str == "at4") solve_puz_PathOnTheHills();
    else if (str == "at5") solve_puz_PathOnTheMountains();
    else if (str == "at6") solve_puz_patternpuzzle();
