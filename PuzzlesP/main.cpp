...
int main(int argc, char **argv)
{
    ...
    println("at3: Path on the Hills");
    println("at4: Path on the Mountains");
    println("at5: patternpuzzle");
    ...
    else if (str == "at3") solve_puz_PathOnTheHills();
    else if (str == "at4") solve_puz_PathOnTheMountains();
    else if (str == "at5") solve_puz_patternpuzzle();
