...
void solve_puz_PleaseComeBack()
{
    using namespace puzzles::PleaseComeBack;
    solve_puzzle<puz_game, puz_state, puz_solver_astar<puz_state>>(
        "Puzzles/PleaseComeBack.xml", "Puzzles/PleaseComeBack.txt", solution_format::GOAL_STATE_ONLY);
}
