...
/*
    iOS Game: Bean Chomper - Color Dots Game

    Summary
    COLOR DOTS GAMEPLAY

    Description
     - Propel your bean eater across a vibrant grid filled with colored beans, and become the true champion of color dots games.
     - Gorging on similar colored beans is the ultimate goal of your bean eater in this thrilling game.
     - As soon as your bean eater munches on mismatched color, the game pauses.
     - Each move matters because of the limitation of steps! Think twice!
     - Clear all beans and you're the victor! Is the color match challenge not intriguing enough for the old school games lover in you?
*/

namespace puzzles::BeanChomper{
...
struct puz_state
{
    puz_state(const puz_game& g)
        : m_cells(g.m_cells), m_game(&g), m_area(g.m_area), m_p(g.m_start) { }
...
void solve_puz_BeanChomper()
{
    using namespace puzzles::BeanChomper;
