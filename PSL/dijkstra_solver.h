...
template<typename T>
concept puz_state_solver_dijkstra = copyable<T> && requires(const T& t, list<T>&children, const T& child, const T& t2)
{
...
template<puz_state_solver_dijkstra puz_state, bool directed = true, bool shortest_paths_only = true, bool first_paths_only = true>
