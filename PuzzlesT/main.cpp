...
extern void solve_puz_TheGreyLabyrinth();
...
int main(int argc, char **argv)
{
    ...
    for(string str; str.empty();) {
        ...
        println("h2: The Grey Labyrinth");
        println("h3: The Magic Number");
        println("h4: The Odd Brick");
        println("h5: Thermometers");
        ...
        println("w: twinballs");
        getline(cin, str);
        if (str.empty()) solve_puz_TheGreyLabyrinth();
        ...
        else if (str == "h2") solve_puz_TheGreyLabyrinth();
        else if (str == "h3") solve_puz_TheMagicNumber();
        else if (str == "h4") solve_puz_TheOddBrick();
        else if (str == "h5") solve_puz_Thermometers();
