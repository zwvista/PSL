...
{
	cout << "a1: Tapa" << endl;
	cout << "a2: Tap-A-Row" << endl;
	cout << "a3: Tap Differently" << endl;
	cout << "a4: tatami" << endl;
	...
	else if(str == "a2") solve_puz_TapARow();
	else if(str == "a3") solve_puz_TapDifferently();
	else if(str == "a4") solve_puz_tatami();
