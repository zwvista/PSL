...
/*
    iOS Game: 100 Logic Games/Puzzle Set 10/Tap-Alike
...
puz_hint puz_state::compute_hint(const Position& p) const
{
    ...
    return puzzles::TapAlike::compute_hint(filled);
}
...
bool puz_state::is_valid_move() const
{
    ...
    return is_interconnected() && is_valid_square({PUZ_FILLED}) && is_tap_alike();
}
